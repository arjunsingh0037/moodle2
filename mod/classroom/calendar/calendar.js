...
//added to show the error if the user enter 
function showerror(val)
{
var name=document.getElementById("durationh").value;
if((name <=0 || empty(name)) && (val<30))
{
document.getElementById("durationm").innerHTML="You have entered the Duration (in mins) Less than 30 mins";
return true;
}
else
{
document.getElementById("durationm").innerHTML="";
return true;
}
}

function showerrorinternal(val)
{

if(val <30)
{

document.getElementById("durationexternal").innerHTML="You have entered the Duration (in mins) Less than 30 mins";
return true;
}
else
{
document.getElementById("durationexternal").innerHTML="";
return true;
}
}
//eded