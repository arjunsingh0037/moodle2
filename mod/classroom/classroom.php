...
$string['sessioncategory'] = 'Session Category';
...
$string['error:emptysessioncategory'] = 'Session Category was empty.';
...
You can fill the feedback using the My ILT Sessions page from the Calendar menu (https://lms.portal.nttdatainc.com/blocks/classroom/myiltraining.php). Please log on with your portal ID & password. Choose the ILT session you had completed  and answer the questions.';
...
***Kindly check all necessary softwares before the session starts***

***Before you start your session, Make sure you take the attendance for the session using the link 
https://lms.portal.nttdatainc.com/blocks/classroom/ilttrainer.php   ***
