<?php
$string['multiplesession']='Allow multiple Sign-ups';
$string['remindersettings']='Reminder Settings';
$string['waitlistsettings']='Waitlist Settings';
$string['absenteessettings']='Absentees Settings';
$string['cancellationmsgsettings']='Cancellation Message Settings';
$string['confirmation']='Confirm Program Settings';
$string['cancellation']='Cancel Program Settings';
$string['managerconfirmation']='Manager Confirmation';
$string['seetrainers'] = 'Add trainers';
$string['copyingattendees'] = 'Copying Attendees';
$string['account'] = 'Account';
$string['externaltraining']='Booking for external training';
$string['seats available'] = 'Seats Available';
...
$string['addremovetrainners'] = 'Add/remove trainers';
$string['givefeedback'] = 'Give feedback';
$string['givefeedbacksession'] = 'Give feedback for the session.';
$string['feedbacktext'] = 'Select feedback';
$string['trainingtype'] = 'Select Training Type';
$string['trainingsource'] = 'Select Training Source';
$string['practice'] = 'Select Practice';
$string['takeattendance']='Take Attendance';
$string['addstudent'] = 'Add student';
$string['alllocations'] = 'All locations';
$string['reschedulereasonlabel'] = 'Reschedule Reason';
$string['allsessionsin'] = 'All sessions in $a';
$string['alreadysignedup'] = 'You have already signed-up for this Classroom activity.';
$string['answer'] = 'Sign in';
$string['answercancel'] = 'Sign out';
$string['assessmentyour'] = 'Your assessment';
$string['cancelreasonlabel'] = 'Cancellation Reason';
$string['attendance'] = 'Attendance';
$string['attendanceinstructions'] = 'Select users who attended the session.';
$string['attendedsession'] = 'Attended session';
$string['attendees'] = 'Attendees';
$string['Trainners'] = 'Trainers';
$string['booked'] = 'Booked';
$string['bookingcancelled'] = 'Your booking has been cancelled.';
$string['classroomrescheduled'] = 'Your Training Class has been Rescheduled.';
$string['classroomfeedback'] = 'Your feedback is important to us.';
$string['classroomregisterilt'] = 'A new project training event is registered on the LMS.';
$string['classroomregisteriltuser'] = 'Thank you for adding the training event on the LMS';
$string['classroomexternalevent'] = 'A new external training event is registered on the LMS.';
$string['classroomexternaleventUser'] = 'Thank you for registering your training on the LMS';
$string['classroomexternaleventattendence'] = 'Your external training event is completed on the LMS';
$string['placeholder:registerfirstname'] = '[registerfirstname]';
$string['placeholder:registerlastname'] = '[registerlastname]';
$string['classroomabsentees'] = 'Absentees for [classroomname] - Dropouts';
$string['edit/reschedule'] = 'Reschedule';
$string['bookingclosed'] = 'Booking Closed';
$string['bookingcompleted'] = 'Your booking has been completed.';
$string['bookingcompletedforsessions'] = 'Your booking has been completed for the following recurring sessions.';
$string['bookingfull'] = 'booking full';
$string['bookingopen'] = 'Booking Open';
$string['programename'] = 'ILT Program Name';
$string['sessioncancelled']='Cancelled';
$string['programenamehead'] = 'Training';
$string['sessioncategory'] = 'Select Session Category';
$string['bookingstatus'] = 'You are booked for the following session';
$string['calendareventdescriptionbooking'] = 'You are booked for this <a href=\"$a\">Classroom session</a>.';
$string['calendareventdescriptionsession'] = 'You have created this <a href=\"$a\">Classroom session</a>.';
...
$string['changemanageremailinstruction'] = 'Please enter the email address for your current manager below. Ex:name.name@nttdata.com';
...
$string['confirmsubmitquestion'] = 'Do you wish to sign up for $a?';
...
$string['absenteesmessage'] = 'Absentees Message';
...
$string['cancelsessionconfirm'] = 'Are you completely sure you want to cancel this session and all sign-ups for this session?';
...
$string['sendnotification'] = 'Email notification';
...
$string['emailabsentees'] = 'Send e-mail to absentees';
$string['email:instrmngr'] = 'Notice for manager';
$string['email:message'] = 'Message';
$string['email:trainermessage'] = 'Trainer Message';
$string['email:participantmessage'] = 'Participant Message';
$string['email:cancelmessage'] = 'Cancellation Message';
$string['email:subject'] = 'Subject';
$string['emptylocation'] = 'Please Choose Location';
$string['error:addalreadysignedupattendee'] = '$a is already signed-up for this Classroom activity.';
$string['error:addattendee'] = 'Could not add $a to the session.';
$string['error:bookingfull'] = 'Booking full. Could not add $a to the session.';
...
$string['error:cronprefix'] = 'Error: classroom cron:';
//naga added
$string['error:emptyduration'] = 'Please Enter Duration.';
$string['placeholder:feedbackid'] = '[feedbackid]';
$string['placeholder:sessionid'] = '[sessionid]';
//naga completed
$string['error:emptymanageremail'] = 'Manager email address empty.';
$string['error:emptylocation'] = 'Please Select Location.';
$string['error:emptyvenue'] = 'Please Select Venue.';
$string['error:emptysessioncategory'] = 'Please Select a Session Category.';
$string['error:emptyrequestor'] = 'Requestor was empty.';
$string['error:emptyaccount'] = 'Account was empty.';
...
$string['error:incorrectcoursemodulesession'] = 'Course Module Classroom Session was incorrect';
$string['error:incorrectclassroomid'] = 'Classroom ID was incorrect';
$string['error:incorrectnotificationtype'] = 'Incorrect notification type supplied';
$string['error:invaliduserid'] = 'Invalid user ID';
$string['error:mustspecifycoursemoduleclassroom'] = 'Must specify a course module or a classroom ID';
...
$string['classroom:editattendees'] = 'Add and remove attendees from a Classroom session';
$string['classroom:editsessions'] = 'Add, edit, copy and delete Classroom sessions';
$string['classroom:signup'] = 'Sign-up for a session';
$string['classroom:takeattendance'] = 'Take attendance';
$string['classroom:view'] = 'View Classroom activities and sessions';
$string['classroom:viewattendees'] = 'View attendance list and attendees';
$string['classroom:viewcancellations'] = 'View cancellations';
$string['classroom:viewemptyactivities'] = 'View empty Classroom activities';
$string['classroombooking'] = 'Classroom booking';
$string['classroomname'] = 'Classroom name';
$string['introductiontext'] = 'Classroom Description ';
$string['classroomsession'] = 'Classroom session';
...
$string['nosigneduptrainer'] = 'No trainer has been added to the session.';
$string['note'] = 'Note';
...
$string['order'] = 'Order'; 
$string['place'] = 'Room';
$string['placeholder:classroomname'] = '[classroomname]';
...
$string['really'] = 'Do you really want to delete all results for this classroom?';
$string['reasonforcancellation'] = 'Reason for Cancellation';
...
This is to inform you that your team member - [firstname] [lastname] has cancelled the booking for the course [classroomname] planned on [alldates].
...
Room:   [room]
';
$string['setting:defaultprogramcancelledsubject'] = 'Program Cancelled.';
$string['setting:defaultprogramcancellationmessage'] = 'This is to advise that The following program in cancelled:
...
This is to inform you that your team member - [firstname] [lastname] has been booked for the course [classroomname] planned on [alldates].

If you are not his/her Team Leader / Manager and believe  that you have received this email by mistake , please reply to this email.  If you have concerns about your  team member taking this course , please discuss  it with him/her directly.
...
This is to confirm that you are now booked on the following session:
...
***Please arrive ten minutes before the session starts***
...
$string['setting:defaultrescheduledmessage'] = 'This is to inform you that [classroomname] is been rescheduled/changed.

Please find the details for the session.
...
You will receive a reminder [reminderperiod] business days before this course.
';
$string['setting:defaultfeedbackmessage']= 'Dear Participant, 

Thank you for attending [classroomname] held on [alldates].
 
We request you to take some time from your valuable schedule to enter your feedback for this session as your feedback is very important to us.

You can fill the feedback using the following link (https://lms.portal.nttdatainc.com/mod/feedback/view.php?id=[feedbackid]&classid=[sessionid]). Please log on with your portal ID & password and answer the questions.';


$string['setting:defaultregisteriltmessage']= 'Project training event [classroomname] held on [alldates] is registerd on the LMS.
Please visit the attendence page and confirm the attendence of the participants.';

$string['setting:defaultregisteriltmessageUser']= '
Thank you for adding the training [classroomname] held on [alldates].
We will validate your entry and confirm the attendance.

Thanks,
Training Helpdesk';
$string['setting:defaultregisteriltmanagermessage']= '*** Advice only ****
Dear [firstname],
Your team member [registerfirstname] [registerlastname] has added a training event [classroomname] on the LMS. The training event was held on 
[alldates].

Thank you,
Training Helpdesk';
$string['classroomregistermanagerilt'] = 'Your team member has added a new training event on the LMS.';
$string['setting:defaultexternaleventtmessage']= '
External training event [classroomname] held on [alldates] is registered on the LMS.
Please visit the attendance page to verify the proof and confirm the attendance.';

$string['setting:defaultexternaleventtmessageuser']= 'Dear [firstname],
Thank you for registering your training [classroomname] on the LMS. We will evaluate your proof of completion and credit your training history.

Thank you,
Training Helpdesk';

$string['setting:defaultexternaleventtmessageuserattendence']= 'Dear [firstname],
The registration of you training event [classroomname] is completed on the LMS. The training hours is credited to your account.

Thank you,
Training Helpdesk';

$string['setting:defaultabsenteesmessage']= 'Dear participants,

You are receiving this communication as you were absent for the training program [classroomname] held on [alldates].
You had confirmed your participation for this program and hence the program was scheduled considering your nominations. 
Your non-participation is resulting in causing inconvenience to the employees who came to attend the training program as well as the trainer.

Please provide the exact reason as to why you were unable to attend this session, nor inform the training team about your inability to attend.

Appreciate your prompt response in this matter and kindly inform your manager.
';

$string['setting:defaultabsenteesinstrmngrdefault'] = "*** Advice only ****

This is to inform you that your team member - [firstname] [lastname] has not attended for the course [classroomname] planned on [alldates].
";
$string['setting:defaultconfirmationmessagetrainer'] = 'Please open the attachment and accept the invite so that it updates your outlook calendar.

This is to confirm that you are now booked as Trainer on the following session:
...
***Kindly check all necessory softwares before the session starts***

***Before you start your session, Make sure you take the attendance for the session using [ ILT SESSIONS -> Takeattendence – Trainer ] link on the top menu of http://lms102.kds.keane.com***

***Please inform the attendees to fill the feedback form for the session by visiting the link https://lms.portal.nttdatainc.com/blocks/classroom/myiltraining.php. ***

Please arrive ten minutes before the session starts

To cancel your booking use the link https://lms.portal.nttdatainc.com/blocks/classroom/myiltraining.php 
To re-schedule your booking you need to cancel this booking and then re-book a new session. 

Before you start your session, Make sure you take the attendance for the session using the link https://lms.portal.nttdatainc.com/blocks/classroom/ilttrainer.php
...
$string['setting:defaultconfirmationsubjectdefault'] = 'Course booking confirmation: [classroomname], [starttime]-[finishtime], [sessiondate]';
...
$string['setting:defaultremindermessagedefault'] = 'This is a reminder that you are booked on the following session:
...
$string['setting:defaultremindersubjectdefault'] = 'Course booking reminder: [classroomname], [starttime]-[finishtime], [sessiondate]';
...
$string['setting:defaultwaitlistedsubjectdefault'] = 'Waitlisting advice for [classroomname]';
...
$string['costcenterdescription'] = 'Cost Center Description';
