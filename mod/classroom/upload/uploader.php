...
if (!$session = classroom_get_session($sessionID)) {
...
$urlexit = $CFG->wwwroot;
$url = $CFG->wwwroot.'/mod/classroom/sessionsRegister.php?f='.$classroom->id;
   ...
   if(move_uploaded_file($_FILES['mFile']["tmp_name"], $UploadDirectory . $NewFileName ))
   {
			...
			$usersignup->sessionid = $sessionID;
			...
			header( 'Location: summary.php?s='.$sessionID ) ;
			}
